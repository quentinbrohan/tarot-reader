var dataTarotCardsList = [

/*
  // Number - (Name) Original Tarot // Tarot Restless
  0 – The Fool // The Undecided
  I – The Magician // The Sorceress
  II – The High Priestess // The Contemptress
  III – The Empress // The Widower
  IV – The Emperor // The Widow
  V – The Hierophant // The Hierophant // HIER pas HEIR. Inverser lettre dans PS 
  VI – The Lovers // The Lovers
  VII – The Chariot // Black Smoke
  VIII – Strength // Revenge
  IX – The Hermit // The Ascetic
  X – Wheel of Fortune // The Void
  XI – Justice // Will
  XII – The Hanged Man // The Hanged Man
  XIII – Death // The Open Grave
  XIV – Temperance //  Treachery
  XV – The Devil // The Degenerate
  XVI – The Tower // The Tower
  XVII – The Star // The Star
  XVIII – The Moon // The Moon
  XIX – The Sun // The Sun
  XX – Judgement // Judgment
  ...
  */
  ...
  [
    name = "The Contemptress",
    image = "arcana-thecontemptress.jpg",
  ...
  [
    name = "The Hierophant",
    image = "arcana-thehierophant.jpg",
  ...
  [
    name = "The Degenerate",
    image = "arcana-thedegenerate.jpg",
  ...
  [
    ...
    reversed = "Additional meaning= Passion",
    category = "cups"
  ],
